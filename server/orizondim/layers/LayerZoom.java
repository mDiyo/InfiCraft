...
public class LayerZoom extends GenLayerOrizon
{
    public LayerZoom(long par1, GenLayerOrizon par3GenLayer)
    {
        super(par1);
    ...
    public static GenLayerOrizon func_35515_a(long par0, GenLayerOrizon par2GenLayer, int par3)
    {
        Object var4 = par2GenLayer;

        for (int var5 = 0; var5 < par3; ++var5)
        {
            var4 = new LayerZoom(par0 + (long)var5, (GenLayerOrizon)var4);
        }

        return (GenLayerOrizon)var4;
    }
}
