...
public class LayerRiverMix extends GenLayerOrizon
{
    private GenLayerOrizon field_35512_b;
    private GenLayerOrizon field_35513_c;

    public LayerRiverMix(long par1, GenLayerOrizon par3GenLayer, GenLayerOrizon par4GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        {
            if (var5[var8] == mod_Orizon.ocean.biomeID)
            {
                var7[var8] = var5[var8];
            }
            else if (var6[var8] >= 0)
            {
                if (var5[var8] == mod_Orizon.icePlains.biomeID)
                {
                    var7[var8] = mod_Orizon.frozenRiver.biomeID;
                }
