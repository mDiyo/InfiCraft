...
public class BlueDirt extends Block
    implements ITextureProvider
{
    public BlueDirt(int id, int tex)
    {
        super(id, tex, Material.ground);
    }
    	...
    	if (meta != 0)
    	{
	        if (canFallBelow(par1World, par2, par3 - 1, par4) && par3 >= 0)
	        {
	            ...
	            if (!BlockSand.fallInstantly && par1World.checkChunksExist(par2 - var8, par3 - var8, par4 - var8, par2 + var8, par3 + var8, par4 + var8))
	            {
	                ...
	                {
	                    FallingDirtEntity var9 = new FallingDirtEntity(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), this.blockID, meta);
