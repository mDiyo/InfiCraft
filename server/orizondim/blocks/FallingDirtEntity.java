...
public class FallingDirtEntity extends Entity
{
    public int blockID;
    public int metadata;
    ...
    public FallingDirtEntity(World par1World)
    {
        super(par1World);
    }

    public FallingDirtEntity(World par1World, double startX, double startY, double startZ, int bID, int md)
    {
        super(par1World);
        this.blockID = bID;
        this.metadata = md;
        ...
        else
        {
            ...
            if (this.onGround)
            {
                ...
                if (this.worldObj.getBlockId(var1, var2, var3) != Block.pistonMoving.blockID)
                {
                    ...
                    if ((!this.worldObj.canBlockBePlacedAt(this.blockID, var1, var2, var3, true, 1) || BlockSand.canFallBelow(this.worldObj, var1, var2 - 1, var3) || !this.worldObj.setBlockAndMetadataWithNotify(var1, var2, var3, this.blockID, this.metadata)) && !this.worldObj.isRemote)
                    {
