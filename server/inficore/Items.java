...
public class Items 
{
	...
	private static void registerItems()
	{
        ...
        multiBowlEmpty = new EmptyBowl(PropsHelperInfiTools.bowlID, "customBowl").setIconCoord(0, 2);
        multiBowlSoup = new SoupBowl(PropsHelperInfiTools.soupBowlID, 8, "Mushroom Stew").setIconCoord(0, 3);
	}
