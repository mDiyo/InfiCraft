    ...
    implements IInventory
{
    ...
    public ChestLogic adjacentChestZPos;
    ...
    public void checkForAdjacentChests()
    {
        ...
        {
            adjacentChestXNeg = (ChestLogic)worldObj.getBlockTileEntity(xCoord - 1, yCoord, zCoord);
        }
        if (worldObj.getBlockId(xCoord + 1, yCoord, zCoord) == Block.chest.blockID)
        {
            adjacentChestXPos = (ChestLogic)worldObj.getBlockTileEntity(xCoord + 1, yCoord, zCoord);
        }
        if (worldObj.getBlockId(xCoord, yCoord, zCoord - 1) == Block.chest.blockID)
        {
            adjacentChestZNeg = (ChestLogic)worldObj.getBlockTileEntity(xCoord, yCoord, zCoord - 1);
        }
        if (worldObj.getBlockId(xCoord, yCoord, zCoord + 1) == Block.chest.blockID)
        {
            adjacentChestZPos = (ChestLogic)worldObj.getBlockTileEntity(xCoord, yCoord, zCoord + 1);
        }
