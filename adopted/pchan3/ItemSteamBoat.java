            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    if (!par2World.isRemote)
                    {
                        ...
                        par2World.spawnEntityInWorld(new EntitySteamBoat(par2World, (double)((float)var35 + 0.5F), (double)((float)var33 + 1.0F), (double)((float)var34 + 0.5F)));
                    }
