...
public class ChestModelLarge extends ChestModel
{
    public ChestModelLarge()
    {
        ...
        this.chestBelow = (new ModelRenderer(this, 0, 20)).setTextureSize(128, 64);
        this.chestBelow.addBox(0.0F, 0.0F, 0.0F, 30, 9, 14, 0.0F);
        this.chestBelow.rotationPointX = 1.0F;
        this.chestBelow.rotationPointY = 7.0F;
