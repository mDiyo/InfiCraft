...
public class MagicSlabBase extends Block
{
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int x, int y, int z)
    {
        ...
        return AxisAlignedBB.getBoundingBox((float)x + bX, (float)y + bY, (float)z + bZ, 
    ...
    public boolean canConnectSlabTo(IBlockAccess iblockaccess, int i, int j, int k)
    {
        ...
        if (Block.blocksList[bID] instanceof MagicSlabBase || bID == Block.stoneSingleSlab.blockID
