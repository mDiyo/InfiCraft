...
public class WorkbenchRender implements ISimpleBlockRenderingHandler
{
	public static int workbenchModelID = RenderingRegistry.getNextAvailableRenderId();
	@Override
	public void renderInventoryBlock (Block block, int metadata, int modelID, RenderBlocks renderer)
	{
		if (modelID == workbenchModelID)
		{
