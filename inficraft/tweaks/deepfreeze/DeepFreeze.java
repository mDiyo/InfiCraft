...
@TransformerExclusions("inficraft.tweaks.deepfreeze")
public class DeepFreeze implements IFMLLoadingPlugin, IFMLCallHook
{
	@Override
	...
	{
		return new String[] { "inficraft.tweaks.deepfreeze.DFClassOverride" };
	}

	@Override
	public String getModContainerClass ()
	{
		return "inficraft.tweaks.deepfreeze.DFContainer";
	}
