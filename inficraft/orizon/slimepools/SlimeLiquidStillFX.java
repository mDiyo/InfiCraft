...
public class SlimeLiquidStillFX extends FMLTextureFX
{
	...
	public SlimeLiquidStillFX()
	{
		this(50, 120, 220, 255, 50, 120, OrizonSlime.slimeStill.blockIndexInTexture, OrizonSlime.slimeStill.getTextureFile());
	}

	public SlimeLiquidStillFX(int redMin, int redMax, int greenMin, int greenMax, int blueMin, int blueMax, int spriteIndex, String texture)
	{
		super(spriteIndex);
