...
public class SlimeLiquidFlowingFX extends FMLTextureFX
{
	...
	public SlimeLiquidFlowingFX()
	{
		this(50, 120, 220, 255, 50, 120, OrizonSlime.slimeFlowing.blockIndexInTexture+1, OrizonSlime.slimeFlowing.getTextureFile());
	}

	public SlimeLiquidFlowingFX(int redMin, int redMax, int greenMin, int greenMax, int blueMin, int blueMax, int spriteIndex, String texture)
	{
		super(spriteIndex);
		this.redMin = redMin;
		this.redMax = redMax;
