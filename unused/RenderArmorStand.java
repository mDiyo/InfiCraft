...
public class RenderArmorStand implements ISimpleBlockRenderingHandler
{
	public static int standModel;
	
	public RenderArmorStand()
    {
		standModel = RenderingRegistry.getNextAvailableRenderId();
    }
	...
	{
		if (modelID == standModel)
		{
			//block.setBlockBounds(0, 0, 0, 1, 0.25F, 1);
