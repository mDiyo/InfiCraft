...
{
	public ArmorStand(int id, Material material) 
	{
		super(id, material);
	...
	{
		return RenderArmorStand.standModel;
	}
	
	@Override
	public TileEntity createNewTileEntity(World world)
	{
		return new ArmorStandLogic();
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int size, float hitX, float hitY, float hitZ)
	{
		...
		ArmorStandLogic logic = (ArmorStandLogic)world.getBlockTileEntity(x, y, z);
