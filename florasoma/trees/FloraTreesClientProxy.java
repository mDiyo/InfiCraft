...
public class FloraTreesClientProxy extends FloraTreesCommonProxy
{
	...
	public void addNames() 
	{
		...
		LanguageRegistry.instance().addStringLocalization("ghostFloraSapling.name", "en_US", "Ghost Sapling");
		...
		LanguageRegistry.instance().addStringLocalization("bushLog.name", "en_US", "Hopseed Wood");
