package mDiyo.inficraft.flora.trees.worldgen;

import java.util.Random;

import mDiyo.inficraft.flora.trees.PHTrees;
...
public class CherryTreeGen extends WorldGenerator
{
    ...
    int heightLimit = 0;
    int height;
    double heightAttenuation = 0.824D;
    ...
    public CherryTreeGen(boolean par1)
    {
        super(par1);
    }
        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    Block block = Block.blocksList[this.worldObj.getBlockId(var11[0], var11[1], var11[2])];

                    if (block != null && !block.isLeaves(worldObj, var11[0], var11[1], var11[2]))
                    {
                        ++var13;
                    }
                    else
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int var5 = par2 + this.leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, PHTrees.cherryLeavesID);
        }
    }
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(var5, var6, PHTrees.treeID);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, PHTrees.treeID);
            }
        }
    }
    ...
    {
        this.heightLimitLimit = (int)(par1 * 18.0D);
