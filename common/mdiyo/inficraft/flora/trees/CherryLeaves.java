...
public class CherryLeaves extends BlockLeavesBase
{
    ...
    public CherryLeaves(int var1, int var2)
    {
            ...
            for (int var7 = -var5; var7 <= var5; ++var7)
            {
                for (int var8 = -var5; var8 <= var5; ++var8)
                {
                    for (int var9 = -var5; var9 <= var5; ++var9)
                    {
                        ...
                        if (var10 == FloraTrees.cherryLeaves.blockID)
                        {
                    ...
                    for (var12 = -var7; var12 <= var7; ++var12)
                    {
                        for (var13 = -var7; var13 <= var7; ++var13)
                        {
                            for (var14 = -var7; var14 <= var7; ++var14)
                            {
                                ...
                                else if (var15 == FloraTrees.cherryLeaves.blockID)
                                {
    ...
    {
        var1.add(new ItemStack(FloraTrees.cherryLeaves, 1, 0));
        var1.add(new ItemStack(FloraTrees.cherryLeaves, 1, 1));
    }
}
