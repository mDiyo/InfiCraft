...
public class EucalyptusTreeGenShort extends WorldGenerator
{
	...
	public boolean generateRandomTree(World world, Random random, int posX, int posY, int posZ)
	{
		...
		for (int k1 = 0; k1 < height; k1++)
		{
			...
			{
				setBlockAndMetadata(world, posX, posY + k1, posZ, FloraTrees.redwood.blockID, mdWood);
			}
		}
	...
	private void genBranch(World world, Random random, int x, int y, int z, int height, int direction)
	{
		...
		for (int bIter = 4; bIter > 0; bIter--)
		{
			...
			posY += branch;
			if(branch == 2)
				setBlockAndMetadata(world, posX, posY-1, posZ, FloraTrees.redwood.blockID, mdWood);
			setBlockAndMetadata(world, posX, posY, posZ, FloraTrees.redwood.blockID, mdWood);
			if(bIter == 1)
	...
	{
		setBlockAndMetadata(world, x, y, z, FloraTrees.redwood.blockID, mdWood);
