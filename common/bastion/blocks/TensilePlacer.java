...
public class TensilePlacer
{
	...
	public TensilePlacer(int var1, int var2, int var3, int var4, int var5, int var6)
	{
		...
		if (var14)
		{
			if (var11 > var18)
			{
				addPath(0, 1, 0, var11 - var18 + 1);
				addPath(var16, 1, var17, var18 + 1);
			}
			else
			{
				addPath(var16, 1, var17, var11 + 1);
				addPath(var16, 0, var17, var18 - var11 + 1);
			}
		}
		else if (var11 > var18)
		{
	...
	{
		while ((this.path_index < this.path.length) && (this.path[this.path_index] != null) && (var3 > 0))
		{
			int[] var4 = this.path[this.path_index];
			int var5 = 0;

			while ((var5 < var4[3]) && (var3 >= 0))
			{
				if (canPlace(var1, this.currentX, this.currentY, this.currentZ))
				{
