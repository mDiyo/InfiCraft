...
public class BastionRenders
{
	public static void renderBarricadeInv(RenderBlocks renderblocks, Block block, int i)
	{
	...
	public static boolean renderBarricade(RenderBlocks renderblocks, IBlockAccess iblockaccess, int x, int y, int z, BarricadeBlock barricade)
	{
		...
		{
			renderInnerEast(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if (((meta < 4) && (meta > 0)) || (meta == 11))
		{
			renderOuterEast(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if ((meta == 2) || (meta == 3) || ((meta >= 8) && (meta <= 11)))
		{
			renderInnerWest(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if ((meta == 3) || ((meta >= 9) && (meta <= 11)))
		{
			renderOuterWest(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if (((meta >= 4) && (meta <= 7)) || (meta >= 14))
		{
			renderInnerSouth(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if (((meta >= 5) && (meta <= 7)) || (meta == 15))
		{
			renderOuterSouth(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if ((meta == 6) || (meta == 7) || (meta >= 12))
		{
			renderInnerNorth(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}

		if ((meta == 7) || (meta >= 13))
		{
			renderOuterNorth(renderblocks, iblockaccess, x, y, z, barricade, tessellator);
		}
