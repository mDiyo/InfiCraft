...
public class PHArmory 
{
	...
	public static void initProps()
    {
		...
		File file = new File(InfiArmory.proxy.getMinecraftDir() + "/config/InfiCraft");
        file.mkdir();
        File newFile = new File(InfiArmory.proxy.getMinecraftDir() + "/config/InfiCraft/Armory.txt");
