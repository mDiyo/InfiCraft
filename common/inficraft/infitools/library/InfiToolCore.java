...
public abstract class InfiToolCore extends ItemTool
{
	...
	public void onUpdate(ItemStack stack, World world, Entity entity, int par4, boolean par5)
	{
		...
		/*if (count == 5)
		{
			...
			{
				if (headType == 12 || headType == 14 || handleType == 12 || handleType == 14)
				{
					if (world.getBlockId((int)entity.posX, (int)entity.posY, (int)entity.posZ) == 0)
						world.setBlockWithNotify((int)entity.posX, (int)entity.posY, (int)entity.posZ, InfiLibrary.lightBlock.blockID);
				}					
			}
		}*/
		if (!(entity instanceof EntityLiving) || rand.nextInt(100) > 0)
			return;
		...
		{
			((EntityLiving) entity).addPotionEffect(new PotionEffect(Potion.poison.id, poison, 0));
		}
	}
	...
	boolean checkDurability(List list, int dur)
	{
		if (dur == 1)
			list.add("Durability I");
		else if (dur == 2)
