...
public enum InfiMaterialEnum
{
    ...
    Stone(1, 131, 4.0F, 1, 5, 2, 0.5F, 0, true),
    Iron(2, 250, 6.0F, 2, 14, 3, 1.3F, 1, false),
    Diamond(4, 1561, 8.0F, 3, 10, 4, 2.0F, 2, false),
    Redstone(3, 71, 12F, 3, 12, 5, 1.0F, 0, false),
    Obsidian(3, 89, 8F, 2, 14, 6, 0.8F, 5, false),
    Sandstone(0, 48, 2.5F, 0, 5, 7, 0.2F, 0, true),
    Bone(1, 200, 5.0F, 2, 8, 8, 1.0F, 0, false),
    Paper(0, 131, 2.0F, 0, 0, 9, 0.1F, 0, true),
    Mossy(4, 170, 8.0F, 3, 22, 10, 1.0F, 0, false),
    Netherrack(2, 131, 4.0F, 1, 8, 11, 1.2F, 0, true),
    Glowstone(3, 572, 6.0F, 1, 12, 12, 1.3F, 0, false),
    Ice(0, 49, 4.0F, 0, 18, 13, 1.0F, 0, false),
    Lava(3, 636, 4.0F, 1, 5, 14, 1.3F, 0, true),
    Slime(3, 1500, 1.5F, 0, 7, 15, 5.0F, 0, false),
    Cactus(1, 150, 5.0F, 2, 14, 16, 1.0F, 0, true),
    Flint(1, 171, 5.25F, 2, 5, 17, 0.7F, 0, false),
    Blaze(4, 1231, 4.0F, 5, 12, 18, 1.58F, 0, true),
    Copper(1, 180, 5.0F, 1, 7, 19, 1.3F, 1, false),
    Bronze(2, 350, 5.25F, 1, 8, 20, 1.3F, 1, false),
    WorkedIron(3, 400, 6.5F, 14, 21, 23, 1.5F, 2, false),
    Steel(3, 550, 7.0F, 2, 14, 22, 1.5F, 2, false),
