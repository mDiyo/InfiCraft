...
public class InfiLibrary
{
	...
	public static CreativeTabs infitools = new TabInfiTools("InfiTools");
	
	@Instance("InfiLibrary")
	public static InfiLibrary instance;
	
	/* Proxies for sides, used for graphics processing */
	@SidedProxy(clientSide = "inficraft.infitools.library.InfiLibraryProxyClient", serverSide = "inficraft.infitools.library.InfiLibraryProxyCommon")
	...
	{
		GameRegistry.addRecipe(new ItemStack(redstoneCrystal, 1), new Object[]
		        { " # ", "#m#", " # ", '#', Item.redstone, 'm', ironChunk });
		GameRegistry.addRecipe(new ItemStack(glowstoneCrystal, 1), new Object[]
		...
		GameRegistry.addRecipe(new ItemStack(blazeCrystal, 1), new Object[]
		...
		//Chainmail
		GameRegistry.addRecipe(new ItemStack(Item.helmetChain, 1), new Object[] {"###", "# #", '#', this.ironChunk});
		GameRegistry.addRecipe(new ItemStack(Item.plateChain, 1), new Object[] {"# #", "###", "###", '#', this.ironChunk});
		GameRegistry.addRecipe(new ItemStack(Item.legsChain, 1), new Object[] {"###", "# #", "# #", '#', this.ironChunk});
		GameRegistry.addRecipe(new ItemStack(Item.bootsChain, 1), new Object[] {"# #", "# #", '#', this.ironChunk});
		
		//Paper
		GameRegistry.addRecipe(new ItemStack(this.paperStack, 1), new Object[]
		        { "##", "##", '#', Item.paper });
		GameRegistry.addRecipe(new ItemStack(Item.paper, 4), new Object[]
		        { "#", '#', this.paperStack });
	    ...
	    //Mossy materials
	    GameRegistry.addRecipe(new ItemStack(mossBall, 4), new Object[]
        ...
        GameRegistry.addRecipe(new ItemStack(mossyPatch, 1), new Object[]
                {
                    "mm", "mm", 'm', mossBall
                });
        GameRegistry.addRecipe(new ItemStack(mossBall, 4), new Object[]
        ...
        GameRegistry.addRecipe(new ItemStack(mossyStone, 1), new Object[]
	...
	private void addMaterialRecipes()
	{
		GameRegistry.addRecipe(new ItemStack(stoneRod, 4), new Object[] 
                { "#", "#", '#', Block.cobblestone });
		GameRegistry.addRecipe(new ItemStack(ironRod, 4), new Object[] 
                { "#", "#", '#', Item.ingotIron });
		GameRegistry.addRecipe(new ItemStack(diamondRod, 4), new Object[] 
                { "#", "#", '#', Item.diamond });
		GameRegistry.addRecipe(new ItemStack(redstoneRod, 4), new Object[] 
                { "#", "#", '#', this.redstoneCrystal });
		GameRegistry.addRecipe(new ItemStack(obsidianRod, 4), new Object[] 
                { "#", "#", '#', Block.obsidian });
		GameRegistry.addRecipe(new ItemStack(sandstoneRod, 4), new Object[] 
                { "#", "#", '#', Block.sandStone });
		GameRegistry.addRecipe(new ItemStack(boneRod, 2), new Object[] 
                { "#", "#", '#', Item.bone });
		GameRegistry.addRecipe(new ItemStack(paperRod, 4), new Object[] 
                { "#", "#", '#', this.paperStack });
		GameRegistry.addRecipe(new ItemStack(mossyRod, 4), new Object[] 
                { "#", "#", '#', this.mossyStone });
		GameRegistry.addRecipe(new ItemStack(netherrackRod, 4), new Object[] 
                { "#", "#", '#', Block.netherrack });
		GameRegistry.addRecipe(new ItemStack(glowstoneRod, 4), new Object[] 
                { "#", "#", '#', this.glowstoneCrystal });
		GameRegistry.addRecipe(new ItemStack(iceRod, 4), new Object[] 
                { "#", "#", '#', Block.ice });
		GameRegistry.addRecipe(new ItemStack(lavaRod, 4), new Object[] 
                { "#", "#", '#', this.lavaCrystal });
		GameRegistry.addRecipe(new ItemStack(slimeRod, 4), new Object[] 
                { "#", "#", '#', this.slimeCrystal });
		GameRegistry.addRecipe(new ItemStack(cactusRod, 4), new Object[] 
                { "#", "#", '#', Block.cactus });
		GameRegistry.addRecipe(new ItemStack(flintRod, 4), new Object[] 
                { "#", "#", '#', Item.flint });
		
		GameRegistry.addRecipe(new ItemStack(Item.stick, 1), new Object[] 
                { "#", "#", "#", '#', this.woodSplinters });
		GameRegistry.addRecipe(new ItemStack(stoneRod, 2), new Object[] 
                { "#", "#", '#', this.stoneShard });
		GameRegistry.addRecipe(new ItemStack(ironRod, 2), new Object[] 
                { "#", "#", '#', this.ironChunk });
		GameRegistry.addRecipe(new ItemStack(diamondRod, 2), new Object[] 
                { "#", "#", '#', this.diamondShard });
		GameRegistry.addRecipe(new ItemStack(redstoneRod, 2), new Object[] 
                { "#", "#", '#', this.redstoneFragment });
		GameRegistry.addRecipe(new ItemStack(obsidianRod, 2), new Object[] 
                { "#", "#", '#', this.obsidianShard });
		GameRegistry.addRecipe(new ItemStack(sandstoneRod, 2), new Object[] 
                { "#", "#", '#', this.sandstoneShard });
		/*GameRegistry.addRecipe(new ItemStack(boneRod, 2), new Object[] 
                { "#", "#", '#', Item.bone });*/
		GameRegistry.addRecipe(new ItemStack(paperRod, 2), new Object[] 
                { "#", "#", '#', Item.paper });
		GameRegistry.addRecipe(new ItemStack(mossyRod, 2), new Object[] 
                { "#", "#", '#', this.mossyPatch });
		GameRegistry.addRecipe(new ItemStack(netherrackRod, 2), new Object[] 
                { "#", "#", '#', this.netherrackShard });
		GameRegistry.addRecipe(new ItemStack(glowstoneRod, 2), new Object[] 
                { "#", "#", '#', this.glowstoneFragment });
		GameRegistry.addRecipe(new ItemStack(iceRod, 2), new Object[] 
                { "#", "#", '#', this.iceShard });
		GameRegistry.addRecipe(new ItemStack(lavaRod, 2), new Object[] 
                { "#", "#", '#', this.lavaFragment });
		GameRegistry.addRecipe(new ItemStack(slimeRod, 2), new Object[] 
                { "#", "#", '#', this.slimeFragment });
		GameRegistry.addRecipe(new ItemStack(cactusRod, 2), new Object[] 
                { "#", "#", '#', this.cactusShard });
		GameRegistry.addRecipe(new ItemStack(flintRod, 2), new Object[] 
                { "#", "#", '#', this.flintShard });
		...
		{
	        GameRegistry.addRecipe(new ItemStack(Item.bow, 1), new Object[]
			...
			GameRegistry.addRecipe(new ItemStack(Block.rail, 16), new Object[]
			    { "c c", "csc", "c c", 'c', new ItemStack(Item.ingotIron, 1, 0), 's', stickArray[stickIter] });
			GameRegistry.addRecipe(new ItemStack(Item.feather, 4), new Object[]
			    { " | ", "s|s", "s|s", '|', stickArray[stickIter], 's', Item.silk });
			GameRegistry.addRecipe(new ItemStack(Item.feather, 4), new Object[]
			{ "s|s", "s|s", " | ", '|', stickArray[stickIter], 's', Item.silk });
			
			for(int shardIter = 0; shardIter < shardArrayShort.length; shardIter++) {
	       		GameRegistry.addRecipe(new ItemStack(Item.arrow, 1), new Object[]
	       	...
	       	GameRegistry.addRecipe(new ItemStack(Block.torchWood, 4),  "m", "|", '|', stickArray[stickIter], 'm', new ItemStack(Item.coal, 1, -1) );
	       	GameRegistry.addRecipe(new ItemStack(Item.fishingRod),  "m", "|", 'm', Item.silk, '|', stickArray[stickIter] );
		}
	    ...
	    GameRegistry.addRecipe(new ItemStack(Item.brewingStand, 1), new Object[]
    ...
    */
    ...
    { //Icons not set yet
    	...
    	grindstone = new Grindstone(PHInfiLibrary.grindstoneID,
    			itemTexture, "Grindstone").setIconCoord(0, 9);
    	
        paperStack = new InfiTexturedItem(PHInfiLibrary.paperStackID, 
        		itemTexture, "Stack of Paper").setIconCoord(0, 4);
        paperDust = new InfiTexturedItem(PHInfiLibrary.paperDustID, 
        		itemTexture, "Dust-filled Paper").setIconCoord(1, 4);
        
        mossBall = new InfiTexturedItem(PHInfiLibrary.mossBallID, 
        		itemTexture, "Ball of Moss").setIconCoord(2, 4);
