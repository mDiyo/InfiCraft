...
public abstract class NetworkTileEntity extends TileEntity {
	...
	public void requestInitialization() throws IOException
	{
        ...
        {
			InfiBlocks.proxy.sendCustomPacket(needsInitPacket());
        }
	}
	...
	{
		InfiBlocks.proxy.sendCustomPacketToPlayersInRange(xCoord, yCoord, zCoord, packet, 160);
	}
}
