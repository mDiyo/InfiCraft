...
public class ChestBlock extends BlockContainer
{
    ...
    public void onNeighborBlockChange(World world, int i, int j, int k, int l)
    {
        ...
        ChestLogic chestlogic = (ChestLogic)world.getBlockTileEntity(i, j, k);
        if (chestlogic != null)
        {
            chestlogic.updateContainingBlockInfo();
        }
    }
    ...
    public void onBlockRemoval(World world, int i, int j, int k)
    {
        ...
        if (chestlogic != null)
        {
            for (int l = 0; l < chestlogic.getSizeInventory(); l++)
            {
                ItemStack itemstack = chestlogic.getStackInSlot(l);
                if (itemstack == null)
                {
                    continue;
                }
    ...
    {
        Object obj = (ChestLogic)world.getBlockTileEntity(i, j, k);
        if (obj == null)
        {
            return true;
        }
        ...
        if (world.getBlockId(i - 1, j, k) == blockID)
        {
            obj = new InventoryLargeChest("Large chest", (ChestLogic)world.getBlockTileEntity(i - 1, j, k), ((IInventory) (obj)));
        }
        if (world.getBlockId(i + 1, j, k) == blockID)
        {
            obj = new InventoryLargeChest("Large chest", ((IInventory) (obj)), (ChestLogic)world.getBlockTileEntity(i + 1, j, k));
        }
        if (world.getBlockId(i, j, k - 1) == blockID)
        {
            obj = new InventoryLargeChest("Large chest", (ChestLogic)world.getBlockTileEntity(i, j, k - 1), ((IInventory) (obj)));
        }
        if (world.getBlockId(i, j, k + 1) == blockID)
        {
            obj = new InventoryLargeChest("Large chest", ((IInventory) (obj)), (ChestLogic)world.getBlockTileEntity(i, j, k + 1));
        }
        if (world.isRemote)
        {
            return true;
