...
public class InfiBlockRenders {
            ...
            IBlockAccess iba, int x, int y, int z, Block block)
    {
        ...
        if ((bID == mod_InfiBlocks.brownstone.blockID && md != 3) 
            || (bID == mod_InfiBlocks.iceBrick.blockID && md != 0)
            || (bID == mod_InfiBlocks.brick.blockID && (md >= 9 || md <= 11) )) {
        ...
        if(eastID == mod_InfiBlocks.iceBrickID && eastMD == 0)
        {
            eastTex += 10;
        } else
        
        if(eastID == mod_InfiBlocks.brownstoneID && eastMD == 3)
        {
            eastTex += 9;
        } else
        ...
        if(westID == mod_InfiBlocks.iceBrickID && westMD == 0)
        {
            westTex += 10;
        } else
        
        if(westID == mod_InfiBlocks.brownstoneID && westMD == 3)
        {
            westTex += 9;
        } else
        ...
        if(northID == mod_InfiBlocks.iceBrickID && northMD == 0)
        {
            northTex += 10;
        } else
        
        if(northID == mod_InfiBlocks.brownstoneID && northMD == 3)
        {
            northTex += 9;
        } else
        ...
        if(southID == mod_InfiBlocks.iceBrickID && southMD == 0)
        {
            southTex += 10;
        } else
        
        if(southID == mod_InfiBlocks.brownstoneID && southMD == 3)
        {
            southTex += 9;
        } else
    ...
    public static void RenderBrickInv(RenderBlocks renderblocks, Block block, int i)
    {
