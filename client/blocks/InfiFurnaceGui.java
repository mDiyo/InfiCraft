...
public class InfiFurnaceGui extends GuiContainer
{
    public InfiFurnaceLogic furnacelogic;

    public InfiFurnaceGui(InventoryPlayer inventoryplayer, InfiFurnaceLogic infifurnacelogic)
    {
        super(new InfiFurnaceContainer(inventoryplayer, infifurnacelogic));
