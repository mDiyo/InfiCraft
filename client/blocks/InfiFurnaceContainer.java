...
public class InfiFurnaceContainer extends Container
{
    public InfiFurnaceLogic tileentity;
    public short progress;
    public short fuel;
    public short fuelGague;

    public InfiFurnaceContainer(InventoryPlayer inventoryplayer, InfiFurnaceLogic infifurnacelogic)
    {
        progress = 0;
        fuel = 0;
        fuelGague = 0;
