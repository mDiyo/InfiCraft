...
public class MagicSlopeRenderHelper
{
	
	private static MagicSlopeRenderHelper instance = new MagicSlopeRenderHelper();
	
	public static MagicSlopeRenderHelper getInstance(){
		return instance;
	}
    		...
    		int posX, int posY, int posZ, float par5, float par6, float par7)
    {
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX, posY - 1, posZ, 0))
        {
            ...
            render.renderBottomFace(par1Block, (double)posX, (double)posY, (double)posZ, par1Block.getBlockTexture(iblockaccess, posX, posY, posZ, 0));
            var8 = true;
        }
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX, posY + 1, posZ, 1))
        {
            ...
            render.colorGreenTopRight *= var12;
            render.colorBlueTopRight *= var12;
            render.renderTopFace(par1Block, (double)posX, (double)posY, (double)posZ, par1Block.getBlockTexture(iblockaccess, posX, posY, posZ, 1));
            var8 = true;
        }
