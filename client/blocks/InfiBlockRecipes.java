...
{	
	...
	public static void recipeStorm()
	{
		...
		{
		ModLoader.addRecipe(new ItemStack(mod_InfiBlocks.infiCraftingTable, 1, iter), new Object[]
				{
		...
		{
			ModLoader.addRecipe(new ItemStack(mod_InfiBlocks.infiFurnace, 1, iter+1), new Object[]
			{
				"bbb", "b b", "bbb", 'b', furnaceArray[iter]
			});
		}
		
		ModLoader.addRecipe(new ItemStack(mod_InfiBlocks.infiFurnace, 1, 0), new Object[]
		{
