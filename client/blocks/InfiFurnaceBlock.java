...
public class InfiFurnaceBlock extends BlockMachineBase
    implements ITextureProvider
{
    int tex;
    Random rand;

    public InfiFurnaceBlock(int i)
    {
    ...
    {
            InfiFurnaceLogic furnaceLogic = (InfiFurnaceLogic)world.getBlockTileEntity(i, j, k);
