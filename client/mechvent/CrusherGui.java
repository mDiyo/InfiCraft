...
{
    public CrusherLogic crusherLogic;

    public CrusherGui(InventoryPlayer inventoryplayer, CrusherLogic logic)
    {
        super(new CrusherContainer(inventoryplayer, logic));
        crusherLogic = logic;
    }

    protected void drawGuiContainerForegroundLayer()
    {
        fontRenderer.drawString("Crusher", 67, 6, 0x404040);
        fontRenderer.drawString("Inventory", 8, (ySize - 96) + 2, 0x404040);
    }

    protected void drawGuiContainerBackgroundLayer(float f, int i, int j)
    {
        int k = mc.renderEngine.getTexture("/mechtex/crusher.png");
