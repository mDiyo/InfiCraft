...
public class CrusherLogic extends BlockLogicPrototype
    implements ISidedInventory
{
    ...
    {
        return CrushingManager.getInstance().findCrusherRecipeChances(itemstack);
    }
    ...
    {
        return new CrusherContainer(inventoryplayer, this);
    }
