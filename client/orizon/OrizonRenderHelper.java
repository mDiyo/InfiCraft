...
public class OrizonRenderHelper
{
	
	private static OrizonRenderHelper instance = new OrizonRenderHelper();
	
	public static OrizonRenderHelper getInstance(){
		return instance;
	}
     ...
     */
    public boolean renderNormalBlock(RenderBlocks render, Block par1Block, 
    		IBlockAccess iblockaccess, int posX, int posY, int posZ)
    {
        int color = par1Block.colorMultiplier(iblockaccess, posX, posY, posZ);
        //int white = 16777215;
        float colorRed = (float)(color >> 16 & 255) / 255.0F;
        float colorBlue = (float)(color >> 8 & 255) / 255.0F;
        float colorGreen = (float)(color & 255) / 255.0F;
        /*float colorWhiteRed = (float)(white >> 16 & 255) / 255.0F;
        float colorWhiteBlue = (float)(white >> 8 & 255) / 255.0F;
        float colorWhiteGreen = (float)(white & 255) / 255.0F;*/

        if (EntityRenderer.anaglyphEnable)
        {
            float var9 = (colorRed * 30.0F + colorBlue * 59.0F + colorGreen * 11.0F) / 100.0F;
            float var10 = (colorRed * 30.0F + colorBlue * 70.0F) / 100.0F;
            float var11 = (colorRed * 30.0F + colorGreen * 70.0F) / 100.0F;
            colorRed = var9;
            colorBlue = var10;
            colorGreen = var11;
        }
        ...
        return Minecraft.isAmbientOcclusionEnabled() && Block.lightValue[par1Block.blockID] == 0 ? 
        		this.renderNormalBlockAO(render, par1Block, iblockaccess, posX, posY, posZ, colorRed, colorBlue, colorGreen) 
        		: this.renderNormalBlockColor(render, par1Block, iblockaccess, posX, posY, posZ, 
     ...
     */
    public boolean renderNormalBlockColor(RenderBlocks render, Block par1Block, IBlockAccess iblockaccess, 
    		int posX, int posY, int posZ, float colorRed, float colorBlue, float colorGreen)
    {
        render.enableAO = false;
        ...
        float var12 = 0.8F;
        float var13 = 0.6F;
        float var14 = var11 * colorRed;
        float var15 = var11 * colorBlue;
        float var16 = var11 * colorGreen;
        float var17 = var10;
        float var18 = var12;
        float var19 = var13;
        float var20 = var10;
        ...
        if (par1Block != mod_Orizon.blueGrass)
        {
            var17 = var10 * colorRed;
            var18 = var12 * colorRed;
            var19 = var13 * colorRed;
            var20 = var10 * colorBlue;
            var21 = var12 * colorBlue;
            var22 = var13 * colorBlue;
            var23 = var10 * colorGreen;
            var24 = var12 * colorGreen;
            var25 = var13 * colorGreen;
        }
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX, posY - 1, posZ, 0))
        {
            tessellator.setBrightness(par1Block.minY > 0.0D ? var26 : par1Block.getMixedBrightnessForBlock(iblockaccess, posX, posY - 1, posZ));
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX, posY + 1, posZ, 1))
        {
            tessellator.setBrightness(par1Block.maxY < 1.0D ? var26 : par1Block.getMixedBrightnessForBlock(iblockaccess, posX, posY + 1, posZ));
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX, posY, posZ - 1, 2))
        {
            tessellator.setBrightness(par1Block.minZ > 0.0D ? var26 : par1Block.getMixedBrightnessForBlock(iblockaccess, posX, posY, posZ - 1));
            tessellator.setColorOpaque_F(var18, var21, var24);
            texture = par1Block.getBlockTexture(iblockaccess, posX, posY, posZ, 2);
            this.renderEastFace(par1Block, render, (double)posX, (double)posY, (double)posZ, texture);

            if (render.cfgGrassFix && texture == 3)
            {
                tessellator.setColorOpaque_F(var18 * colorRed, var21 * colorBlue, var24 * colorGreen);
                this.renderEastFace(par1Block, render, (double)posX, (double)posY, (double)posZ, 1);
            }
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX, posY, posZ + 1, 3))
        {
            tessellator.setBrightness(par1Block.maxZ < 1.0D ? var26 : par1Block.getMixedBrightnessForBlock(iblockaccess, posX, posY, posZ + 1));
            tessellator.setColorOpaque_F(var18, var21, var24);
            texture = par1Block.getBlockTexture(iblockaccess, posX, posY, posZ, 3);
            this.renderWestFace(par1Block, render, (double)posX, (double)posY, (double)posZ, texture);
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX - 1, posY, posZ, 4))
        {
            tessellator.setBrightness(par1Block.minX > 0.0D ? var26 : par1Block.getMixedBrightnessForBlock(iblockaccess, posX - 1, posY, posZ));
            tessellator.setColorOpaque_F(var19, var22, var25);
            texture = par1Block.getBlockTexture(iblockaccess, posX, posY, posZ, 4);
            this.renderNorthFace(par1Block, render, (double)posX, (double)posY, (double)posZ, texture);

            if (render.cfgGrassFix && texture == 3)
            {
                tessellator.setColorOpaque_F(var19 * colorRed, var22 * colorBlue, var25 * colorGreen);
                this.renderNorthFace(par1Block, render, (double)posX, (double)posY, (double)posZ, 1);
            }
        ...
        if (render.renderAllFaces || par1Block.shouldSideBeRendered(iblockaccess, posX + 1, posY, posZ, 5))
        {
            tessellator.setBrightness(par1Block.maxX < 1.0D ? var26 : par1Block.getMixedBrightnessForBlock(iblockaccess, posX + 1, posY, posZ));
            tessellator.setColorOpaque_F(var19, var22, var25);
            texture = par1Block.getBlockTexture(iblockaccess, posX, posY, posZ, 5);
            this.renderSouthFace(par1Block, render, (double)posX, (double)posY, (double)posZ, texture);
