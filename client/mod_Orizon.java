...
public class mod_Orizon extends NetworkMod
{
    ...
    public mod_Orizon()
    {
        ...
        MinecraftForgeClient.preloadTexture("/oretex/organics.png");
        
        Minecraft mc = ModLoader.getMinecraftInstance();
        
        //ColorizerWater.setWaterBiomeColorizer(mc.renderEngine.getTextureContents("/misc/watercolor.png"));
        OrizonColorizer.setGrassBiomeColorizer(mc.renderEngine.getTextureContents("/oretex/grasscolor.png"));
        OrizonColorizer.getFoilageBiomeColorizer(mc.renderEngine.getTextureContents("/oretex/foliagecolor.png"));
	...
	{
		if (modelID == blueGrassModelID)
		{
			return OrizonRenderHelper.getInstance().renderNormalBlock(renderblocks, block, iblockaccess, i, j, k);
		}
		return false;
	}
	...
	public void renderInvBlock(RenderBlocks renderblocks, Block block, int i, int modelID)
	{
		if (modelID == blueGrassModelID)
		{
			OrizonRenderHelper.getInstance().RenderDo(renderblocks, block, i);
		}
	}
    ...
    public static void initBiomes()
    {
    	...
    	((BiomeGenOrizon) forest.setColor(353825).setBiomeName("Orizon Forest").func_4124_a(5159473)).setRainAndTemp(0.7F, 0.8F);
    	((BiomeGenOrizon) taiga.setColor(747097).setBiomeName("Orizon Taiga").func_4124_a(5159473).setEnableSnow()).setRainAndTemp(0.05F, 0.8F);
    	taiga.setHeight(0.1F, 0.4F);
    	((BiomeGenOrizon) swampland.setColor(522674).setBiomeName("Orizon Swampland").func_4124_a(9154376)).setRainAndTemp(0.8F, 0.9F);
    	...
    	((BiomeGenOrizon) forestHills.setColor(2250012).setBiomeName("Orizon Fores tHills").func_4124_a(5159473)).setRainAndTemp(0.7F, 0.8F);
    	forestHills.setHeight(0.2F, 0.6F);
    	((BiomeGenOrizon) taigaHills.setColor(1456435).setBiomeName("Orizon Taiga Hills").setEnableSnow().func_4124_a(5159473)).setRainAndTemp(0.05F, 0.8F);
    	taigaHills.setHeight(0.2F, 0.7F);
    	((BiomeGenOrizon) jungle.setColor(5470985).setBiomeName("Orizon Jungle").func_4124_a(5470985)).setRainAndTemp(1.2F, 0.9F);
    	jungle.setHeight(0.2F, 0.4F);
    	((BiomeGenOrizon) jungleHills.setColor(2900485).setBiomeName("Orizon Jungle Hills").func_4124_a(5470985)).setRainAndTemp(1.2F, 0.9F);
