    ...
    implements ITextureProvider
{
    ...
    public boolean onBlockStartBreak(ItemStack itemstack, int i, int j, int k, EntityPlayer entityplayer)
    {
        ...
        if (type1 == type2)
        {
            flag = powers(itemstack, bID, i, j, k, world, entityplayer, md, type1);
        }
        else
        {
            ...
            {
                flag1 = powers(itemstack, bID, i, j, k, world, entityplayer, md, type2);
            }
        }
        ...
        if (!flag || !flag1)
        {
            world.playAuxSFX(2001, i, j, k, bID + md * 256);
            world.setBlockWithNotify(i, j, k, 0);
            onBlockDestroyed(itemstack, bID, i, j, k, entityplayer);
            return true;
        }
        else
        {
