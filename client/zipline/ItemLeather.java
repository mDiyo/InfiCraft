...
public class ItemLeather extends Item
{
    ...
    public ItemLeather(int var1, int var2)
    {
        super(78);
        this.blockID = var2;
        this.setIconIndex(103);
        this.setItemName("leather");
    }
    ...
    public boolean onItemUse(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7)
    {
        ...
        else
        {
            ...
            if (var5 == 127 && Block.blocksList[this.blockID].blockMaterial.isSolid())
            {
                return false;
            }
            else if (var3.canBlockBePlacedAt(this.blockID, var4, var5, var6, false, var7))
            {
                ...
                if (var3.setBlockAndMetadataWithNotify(var4, var5, var6, this.blockID, this.getMetadata(var1.getItemDamage())))
                {
                    ...
                    var3.playSoundEffect((double)((float)var4 + 0.5F), (double)((float)var5 + 0.5F), (double)((float)var6 + 0.5F), var8.stepSound.getBreakSound(), (var8.stepSound.getVolume() + 1.0F) / 2.0F, var8.stepSound.getPitch() * 0.8F);
                    --var1.stackSize;
                }
