...
public class SpearEntity extends InfiEntityRotating
{

    public void damageBoomerang(int i, boolean flag)
    {
        /*if(returnStack.itemID == mod_Rangecraft.itemSpearWood.shiftedIndex && fire > 0)
        {
            i *= 6;
        }*/
    ...
    public SpearEntity(World world, double d, double d1, double d2)
    {
        super(world, d, d1, d2);
    }

    public SpearEntity(World world, EntityLiving entityliving, float f, float f1)
    {
    ...
    public void onHit(MovingObjectPosition movingobjectposition)
    {
        if(movingobjectposition.entityHit != null)
        {
            if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(owner), damageDealt))
            {
                ...
                damageBoomerang(1, true);
                if (movingobjectposition.entityHit instanceof EntityLiving)
                {
                	InfiToolSpear spear = (InfiToolSpear) returnStack.getItem();
	                this.hitEntity(returnStack, (EntityLiving) movingobjectposition.entityHit, owner, spear);
        ...
        } else
        {
            ...
            float f = MathHelper.sqrt_double(motionX * motionX + motionY * motionY + motionZ * motionZ) * 1.5F;
