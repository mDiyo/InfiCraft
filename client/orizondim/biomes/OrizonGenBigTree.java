...
public class OrizonGenBigTree extends WorldGenerator
{
    /**
    ...
    public OrizonGenBigTree(boolean par1)
    {
        super(par1);
    }
     ...
     */
    void generateOrizonLeafNodeList()
    {
        ...
        {
            int var7 = 0;
            float var8 = this.orizonLayerSize(var6);
            ...
            else
            {
                for (double var9 = 0.5D; var7 < var1; ++var7)
                {
                    ...
                    if (this.orizonCheckBlockLine(var17, var18) == -1)
                    {
                        ...
                        if (this.orizonCheckBlockLine(var19, var17) == -1)
                        {
                            var2[var4][0] = var15;
                            var2[var4][1] = var3;
                            var2[var4][2] = var16;
    ...
    void genOrizonTreeLayer(int par1, int par2, int par3, float par4, byte par5, int par6)
    {
     ...
     */
    float orizonLayerSize(int par1)
    {
     ...
     */
    void orizonGenerateLeafNode(int par1, int par2, int par3)
    {
        int var4 = par2;
     ...
     */
    void orizonPlaceBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, int par3)
    {
    ...
    void orizonGenerateLeaves()
    {
        ...
        for (int var2 = this.leafNodes.length; var1 < var2; ++var1)
        {
            ...
            this.orizonGenerateLeafNode(var3, var4, var5);
        }
    }
     ...
     */
    boolean orizonLeafNodeNeedsBase(int par1)
    {
    ...
    void orizonGenerateTrunk()
    {
        ...
        this.orizonPlaceBlockLine(var5, var6, 17);
     ...
     */
    void orizonGenerateLeafNodeBases()
    {
        int var1 = 0;
     ...
     */
    int orizonCheckBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
     ...
     * limit, is valid.
     */
    boolean orizonValidTreeLocation()
    {
        ...
        {
            int var4 = this.orizonCheckBlockLine(var1, var2);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (!this.orizonValidTreeLocation())
        {
            return false;
        }
        else
        {
            this.generateOrizonLeafNodeList();
            this.orizonGenerateLeaves();
            this.orizonGenerateTrunk();
            this.orizonGenerateLeafNodeBases();
            return true;
        }
    }
}
