...
public class OrizonGenHugeTrees extends WorldGenerator
{
    ...
    public OrizonGenHugeTrees(boolean par1, int par2, int par3, int par4)
    {
        super(par1);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
                ...
                for (var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
                {
                    for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var12 != 0 && var12 != mod_Orizon.dimensionLeavesID && var12 != mod_Orizon.blueGrass.blockID && var12 != mod_Orizon.blueDirt.blockID && var12 != mod_Orizon.dimensionWood.blockID && var12 != mod_Orizon.dimensionSapling.blockID)
                            {
                                var7 = false;
                            }
                        }
            ...
            else
            {
                ...
                {
                    par1World.setBlock(par3, par4 - 1, par5, mod_Orizon.blueDirt.blockID);
                    par1World.setBlock(par3 + 1, par4 - 1, par5, mod_Orizon.blueDirt.blockID);
                    par1World.setBlock(par3, par4 - 1, par5 + 1, mod_Orizon.blueDirt.blockID);
                    par1World.setBlock(par3 + 1, par4 - 1, par5 + 1, mod_Orizon.blueDirt.blockID);
                    ...
                    for (int var14 = par4 + var6 - 2 - par2Random.nextInt(4); var14 > par4 + var6 / 2; var14 -= 2 + par2Random.nextInt(4))
                    {
                        ...
                        for (int var13 = 0; var13 < 5; ++var13)
                        {
                            ...
                            this.setBlockAndMetadata(par1World, var11, var14 - 3 + var13 / 2, var12, mod_Orizon.dimensionWood.blockID, this.woodMetadata);
                        }
                    }
                    ...
                    for (var10 = 0; var10 < var6; ++var10)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var10, par5, mod_Orizon.dimensionWood.blockID, this.woodMetadata);
                        ...
                        if (var10 < var6 - 1)
                        {
                            ...
                            if (var11 == 0 || var11 == Block.leaves.blockID)
                            {
                                this.setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5, mod_Orizon.dimensionWood.blockID, this.woodMetadata);
                            ...
                            if (var11 == 0 || var11 == Block.leaves.blockID)
                            {
                                this.setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5 + 1, mod_Orizon.dimensionWood.blockID, this.woodMetadata);
                            ...
                            if (var11 == 0 || var11 == Block.leaves.blockID)
                            {
                                this.setBlockAndMetadata(par1World, par3, par4 + var10, par5 + 1, mod_Orizon.dimensionWood.blockID, this.woodMetadata);
        ...
        for (int var8 = par4 - var7; var8 <= par4; ++var8)
        {
            ...
            for (int var11 = par2 - var10; var11 <= par2 + var10 + 1; ++var11)
            {
                ...
                for (int var13 = par3 - var10; var13 <= par3 + var10 + 1; ++var13)
                {
                    ...
                    {
                        this.setBlockAndMetadata(par1World, var11, var8, var13, mod_Orizon.dimensionWood.blockID, this.leavesMetadata);
                    }
                }
            }
        }
