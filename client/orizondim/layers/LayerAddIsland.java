...
public class LayerAddIsland extends GenLayerOrizon
{
    public LayerAddIsland(long par1, GenLayerOrizon par3GenLayer)
    {
        super(par1);
        ...
        for (int var11 = 0; var11 < par4; ++var11)
        {
            for (int var12 = 0; var12 < par3; ++var12)
            {
                ...
                if (var17 == 0 && (var13 != 0 || var14 != 0 || var15 != 0 || var16 != 0))
                {
                    ...
                    else if (var19 == mod_Orizon.icePlains.biomeID)
                    {
                        var10[var12 + var11 * par3] = mod_Orizon.frozenOcean.biomeID;
                    }
                    else
                    {
                ...
                else if (var17 > 0 && (var13 == 0 || var14 == 0 || var15 == 0 || var16 == 0))
                {
                    if (this.nextInt(5) == 0)
                    {
                        if (var17 == mod_Orizon.icePlains.biomeID)
                        {
                            var10[var12 + var11 * par3] = mod_Orizon.frozenOcean.biomeID;
                        }
                        else
