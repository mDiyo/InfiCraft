...
public class RavineGenOrizon extends GenBaseOrizon
{
    private float[] field_35627_a = new float[1024];

    protected void generateRavine(long par1, int par3, int par4, short[] blockIDs, byte[] metdata, double par6, double par8, double par10, float par12, float par13, float par14, int par15, int par16, double par17)
    {
                    ...
                    for (var41 = var56; !var58 && var41 < var35; ++var41)
                    {
                        for (int var42 = var57; !var58 && var42 < var39; ++var42)
                        {
                            for (int var43 = var37 + 1; !var58 && var43 >= var55 - 1; --var43)
                            {
                                ...
                                {
                                    if (blockIDs[var44] == Block.waterMoving.blockID || blockIDs[var44] == Block.waterStill.blockID)
                                    {
                                        var58 = true;
                                    }
                                    ...
                                    for (int var49 = var37 - 1; var49 >= var55; --var49)
                                    {
                                        ...
                                        if ((var59 * var59 + var45 * var45) * (double)this.field_35627_a[var49] + var50 * var50 / 6.0D < 1.0D)
                                        {
                                            ...
                                            if (var52 == Block.stone.blockID || var52 == Block.dirt.blockID || var52 == Block.grass.blockID)
                                            {
                                                if (var49 < 10)
                                                {
                                                    blockIDs[var47] = (short)Block.lavaMoving.blockID;
                                                }
                                                else
                                                {
                                                    blockIDs[var47] = 0;

                                                    if (var48 && blockIDs[var47 - 1] == Block.dirt.blockID)
                                                    {
                                                        blockIDs[var47 - 1] = this.worldObj.getBiomeGenForCoords(var41 + par3 * 16, var44 + par4 * 16).topBlock;
                                                    }
                                                }
                                            }
                                        }
    ...
    protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, short[] blockIDs, byte[] metadata)
    {
        if (this.rand.nextInt(50) == 0)
        {
            ...
            for (int var14 = 0; var14 < var13; ++var14)
            {
                ...
                this.generateRavine(this.rand.nextLong(), par4, par5, blockIDs, metadata, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D);
            }
        }
    }
}
