...
public class OrizonSapling extends OrizonFlower
	implements ITextureProvider
{
    protected OrizonSapling(int par1, int par2)
    {
        super(par1, par2);
        float var3 = 0.4F;
    ...
    {
        return par1 == mod_Orizon.blueGrass.blockID || par1 == mod_Orizon.blueDirt.blockID;
    }
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (var6 == 1)
        {
            var7 = new OrizonGenTaiga(true);
        }
        else if (var6 == 2)
        {
            var7 = new OrizonGenForest(true);
        }
        else if (var6 == 3)
        {
            for (var8 = 0; var8 >= -1; --var8)
            {
                for (var9 = 0; var9 >= -1; --var9)
                {
                    ...
                    {
                        var7 = new OrizonGenHugeTrees(true, 10 + par5Random.nextInt(20), 3, 3);
                        var10 = true;
                        break;
                    }
                }
            ...
            if (var7 == null)
            {
                var9 = 0;
                var8 = 0;
                var7 = new OrizonGenTrees(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
            var7 = new OrizonGenTrees(true);

            if (par5Random.nextInt(10) == 0)
            {
                var7 = new OrizonGenBigTree(true);
            }
        }
