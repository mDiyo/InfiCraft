...
public class OrizonLeaves extends BlockLeaves 
	implements IShearable, ITextureProvider
{
    /**
    ...
    public OrizonLeaves(int par1, int par2)
    {
        super(par1, par2);
                    ...
                    for (var12 = -var7; var12 <= var7; ++var12)
                    {
                        for (var13 = -var7; var13 <= var7; ++var13)
                        {
                            for (var14 = -var7; var14 <= var7; ++var14)
                            {
                                ...
                                if (var15 == mod_Orizon.dimensionWood.blockID)
                                {
                                    this.adjacentTreeBlocks[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = 0;
                                }
                                else if (var15 == mod_Orizon.dimensionLeaves.blockID)
                                {
    ...
    {
        return mod_Orizon.dimensionSaplingID;
    }
    ...
    {
        return (par2 & 3) == 1 ? this.blockIndexInTexture + 2 : ((par2 & 3) == 3 ? this.blockIndexInTexture + 4 : this.blockIndexInTexture);
    }
