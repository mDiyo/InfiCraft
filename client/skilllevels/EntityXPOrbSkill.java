...
public class EntityXPOrbSkill extends EntityXPOrb
{
    /**
    ...
    private int skillExpValue;
    
    private String skill;

    public EntityXPOrbSkill(World par1World, double par2, double par4, double par6, int par8, String skillType)
    {
        super(par1World);
    ...
    public EntityXPOrbSkill(World par1World, String skillType)
    {
        super(par1World);
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setShort("Value", (short)this.skillExpValue);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.skillExpValue = par1NBTTagCompound.getShort("Value");
    }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote)
        {
            if (this.field_35126_c == 0 && par1EntityPlayer.xpCooldown == 0)
            {
                ...
                //par1EntityPlayer.addSkillExperience(skill, this.skillExpValue); TODO: Move to API
                this.setDead();
            }
        }
    }
    ...
    {
        return this.skillExpValue >= 2477 ? 10 : (this.skillExpValue >= 1237 ? 9 : (this.skillExpValue >= 617 ? 8 : (this.skillExpValue >= 307 ? 7 : (this.skillExpValue >= 149 ? 6 : (this.skillExpValue >= 73 ? 5 : (this.skillExpValue >= 37 ? 4 : (this.skillExpValue >= 17 ? 3 : (this.skillExpValue >= 7 ? 2 : (this.skillExpValue >= 3 ? 1 : 0)))))))));
    }
