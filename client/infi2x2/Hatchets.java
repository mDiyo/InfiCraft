...
public class Hatchets 
{
    ...
    {
    	ModLoader.addName(woodWoodHatchet, "Wood Hatchet");
    	...
    	ModLoader.addName(netherrackNetherrackHatchet, "Blood Pick");
        ...
        ModLoader.addName(arditeArditeHatchet, "Rustic StoneDigger");
