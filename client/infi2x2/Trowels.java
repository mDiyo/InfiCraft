...
public class Trowels 
{
    ...
    {
    	ModLoader.addName(woodWoodTrowel, "Wood Trowel");
    	...
    	ModLoader.addName(netherrackNetherrackTrowel, "Blood Pick");
        ...
        ModLoader.addName(arditeArditeTrowel, "Rustic StoneDigger");
