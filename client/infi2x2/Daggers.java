...
public class Daggers 
{
    ...
    {
    	ModLoader.addName(woodWoodDagger, "Wood Dagger");
    	...
    	ModLoader.addName(netherrackNetherrackDagger, "Blood Pick");
        ...
        ModLoader.addName(arditeArditeDagger, "Rustic StoneDigger");
